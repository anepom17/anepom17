...
| **LLM Models (2026)** | **Gemini 1.5 Pro / Flash**, **GPT-4o**, Claude 3.5 Sonnet (понимание нюансов моделей) |
...
**2009 — настоящее время (15+ лет)** Путь от оператора данных до руководителя продукта. Навыки: анализ требований, координация команд, data-driven принятие решений, управление продуктом.
